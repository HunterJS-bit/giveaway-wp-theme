...
<div class="container  mx-auto px-2 pt-12 md:pt-8 flex flex-col">
  <div class="md:flex relative flex-row-reverse items-center">
      <div class="w-full md:w-1/2 h-full text-center">
          <div class="relative">
              <div>
                  <div class="mx-auto md:w-full mx-auto text-center flex align-center items-center justify-center">
                    <img
      ...
      <div class="md:w-full">
        <h1 class="py-4 md:py-8 pb-8 text-grey-darkest text-4xl md:text-5xl font-bold">
         Učestvujte u nagradnim igrama i osvojite vredne nagrade</h1>
      </div> 
          <h2 class="text-grey-darker text-base md:text-2xl mx-auto leading-normal md:pr-4">
          Pratite sve nagradne igre i konkurse na jednom mestu
          </h2> 
          <a class="mx-auto rounded-lg mt-10 inline-block px-16 py-4 text-white text-lg bg-green-500 font-semibold shadow-xl cursor-pointer">
          Priključite se </a>
  </div>   
</div>
      ...
      <div class="md:flex justify-around text-center">
        <div class="w-full max-w-xs px-10 mb-10 ">
            <div class="mx-auto text-center">
              <img src="<?php bloginfo('template_url'); ?>/images/nagradne-igre.org_osvoji.svg" alt="Nagrada Osvoji" class="mx-auto css-v7v99c">
            </div>
        ...
        <div class="w-full max-w-xs px-10 mb-10">
            <div class="mx-auto text-center">
              <img src="<?php bloginfo('template_url'); ?>/images/nagradne-igre.org_prati.svg" alt="Nagrada PC" class="mx-auto css-v7v99c">
            </div>
